...
using Adita.PlexNet.Wpf.Security.Authorization;
using System.Security.Claims;
using System.Windows;
using System.Windows.Controls;

namespace Adita.PlexNet.Wpf.Security.Test.Authorization
{
    [TestClass]
    public class AuthorizeTest
    {
        ...
        {
            Core.Security.Claims.ApplicationIdentity applicationIdentity = new("password");
